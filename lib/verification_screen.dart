...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  /// ✅ Send OTP via email using Mailer package
  Future<void> _sendOTP() async {
    ...
    String username = "your-email@gmail.com"; // Use your Gmail
    String password = "your-app-password"; // Use an App Password
  ...
  void _verifyOTP() {
    if (_otpController.text.trim() == _generatedOTP) {
      ...
      // ✅ Mark student as verified in Firestore
      ...
      Navigator.pushReplacement(
        context,
        CustomPageRoute(
          page: StudentHomeScreen(studentName: widget.studentId),
        ),
      );
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: _isLoading
            ? CircularProgressIndicator() // Show loading indicator while sending OTP
            : Column(
